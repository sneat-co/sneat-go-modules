...
type CreateAssetData struct {
	models4assets.AssetMainDto
	models4assets.AssetSpecificData
}

// CreateAssetRequest is a DTO for creating an asset
type CreateAssetRequest struct {
	dto4teamus.TeamRequest
	Asset  models4assets.AssetCreationData `json:"asset"`
	DbData models4assets.AssetDbData       `json:"-"`
}
...
type CreateAssetResponse struct {
	ID   string                    `json:"id"`
	Data models4assets.AssetDbData `json:"data"`
}
...
func CreateAsset(ctx context.Context, user facade.User, request CreateAssetRequest) (response CreateAssetResponse, err error) {
	...
	err = dal4teamus.CreateTeamItem(ctx, user, "assets", request.TeamRequest, assetus.ModuleID,
		func(ctx context.Context, tx dal.ReadwriteTransaction, params *dal4teamus.ModuleTeamWorkerParams[*models4assets.AssetusTeamDto]) (err error) {
