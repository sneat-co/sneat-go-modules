...
require (
	...
	github.com/bots-go-framework/bots-fw v0.25.0 // indirect
	github.com/bots-go-framework/bots-fw-telegram v0.8.2 // indirect
	github.com/bots-go-framework/bots-fw-telegram-models v0.1.2 // indirect
	github.com/bots-go-framework/bots-go-core v0.0.2 // indirect
	github.com/dal-go/mocks4dalgo v0.1.17 // indirect
